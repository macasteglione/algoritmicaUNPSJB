...
public class LinkedPositionalList<E> implements PositionalList<E> {
    ...
    public Position<E> addBefore(Position<E> p, E e) throws IllegalArgumentException {
        ...
        if (p == first())
            addFirst(e); // Si la posición es la primera, agregar el elemento como primer elemento
        else {
            Position<E> posAnterior = before(p); // Obtener la posición anterior a la posición dada
            addAfter(posAnterior, e); // Agregar el nuevo elemento después de la posición anterior
        }
        Position<E> posNuevo = before(p); // Obtener la posición del nuevo elemento agregado
        return posNuevo;
    }
