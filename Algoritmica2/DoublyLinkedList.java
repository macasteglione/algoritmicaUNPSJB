...
public class DoublyLinkedList<E> implements Cloneable {
	...
	/* Si fromIndex <0 o toIndex >= al tama�o de la lista, lanza la excepcion: IndexOutOfBoundsException  */
	/* Si fromIndex > toIndex, lanza la excepci�n: IllegalArgumentException */	
	...
	public DoublyLinkedList<E> rightList(int p) {
		...
		DoublyLinkedList<E> nuevaLista = new DoublyLinkedList<E>();
		int i = 0;
		...
		while (current.next != null) {
			nuevaLista.addLast(current.element);
			current = current.next;
		}
		return nuevaLista;
	}
