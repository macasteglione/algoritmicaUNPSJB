...
public class SinglyLinkedList<E> {
	...
	public E removeElement(E e) {
		...
		if (current.next == null)
			return null;
		Node<E> nodoEliminado = current.next;
		current.next = current.next.next;
		nodoEliminado.next = null;
		size--;
		return nodoEliminado.element;
	}
	...
	public boolean equals(Object o) {
		if (o == null || getClass() != o.getClass())
			return false;
		SinglyLinkedList<E> otraLista = (SinglyLinkedList<E>) o;
		if (otraLista.size != size)
			return false;
		Node<E> current = head;
		Node<E> aux = otraLista.head;
		while (current != null) {
			if (!current.element.equals(aux.element))
				return false;
			current = current.next;
			aux = aux.next;
		}
